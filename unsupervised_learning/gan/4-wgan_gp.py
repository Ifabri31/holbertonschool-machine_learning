...
class WGAN_GP(keras.Model):
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """
        Replace the generator's weights with those stored in the .h5
            file specified by gen_h5.
        Replace the discriminator's weights with those stored in the .h5
            file specified by disc_h5.
        """
